...
console.log("calculateSum(5)", calculateSum(5)); // vВиведе: 15
...
function isEmptyString(str) {
  ...
  else{return false}// В іншому випадку, якщо str містить хоча б один символ, то str не є порожнім рядком, тому повертаємо false
}
...
function checkDataType(value) {
 ...
 typeof value;// Отримуємо тип значення value за допомогою оператора typeof
  //console.log( "Значення "value "має тип " checkDataType(value)); Виводимо у консоль повідомлення, яке містить значення value та його тип
...
function findMax(num1, num2) {
 if(num1>num2) // Порівнюємо num1 та num2
  ...
  else{return num2;}// В іншому випадку (якщо num2 більше або дорівнює num1), то num2 є максимальним, тому повертаємо num2
}
...
function getUserStatus(age) {
 ...
 if(age<18){return 'Неповнолітній';} 
  else{if(age>=65){return 'Пенсіонер';}
  else{return 'Дорослий'}
}
...
function getDayOfWeek(dayNumber) {
  ...
  default: day='Невірний номер дня'; break
}
return day;
...
function getVariableType(variable) {
  const varType=typeof(variable);
   switch(varType){
    ...
    case 'number': console.log("Це число");break;
    case 'string':console.log("Це рядок");break;
    case 'boolean':console.log("Це булеве значення");break;
    default:console.log("Це інший тип");break;
   }
...
const getAdder = function(){makeAdder(5);};
...
function memoizedArea(arg) {
  let oldArg;// Ініціалізуємо примітивні змінні для зберігання попереднього аргументу та результату
...
// 1console.log("squareArea(5)", squareArea(5)); // Виводить "Fetching from cache" і виводить 25 з кешу
...
const createCompose=compose(increment(n),double(increment(n)));
